...
otp.config_defaults = {
    ...
    planner: {
        ...
        options: {
            ...
            showBikeshareMode: false,   // turn on/off the bikeshare options in the mode pull down
            showTrainMode: false,   // turn on/off the train options in the mode pull down
    ...
    map: {
        ...
        baseLayer: [
		layerArray[0] = new OpenLayers.Layer.OSM(
               "Open Street Map"
           ),
		 layerArray[1] = new OpenLayers.Layer.Google(
	'Google Street Maps',
	...
	-20037508.34, -20037508.34, 20037508.34, 20037508.34)
		 ...
		 layerArray[2] = new OpenLayers.Layer.Google(
