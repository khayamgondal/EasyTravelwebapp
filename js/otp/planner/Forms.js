...
otp.planner.StaticForms = {
    ...
    */
    getFormData: function (url) {
        ...
        //window.alert(retVal.preferredRoutes);
        return retVal;
    },
    ...
    */
    makeMainPanel: function () {
        ...
        this.m_locateButton = new Ext.Button({
            text: "Locate Me",
            id: 'trip-submit2',
            scope: this,
            style: 'background-color:FF0000;'
        ...
        this.m_nearByButton = new Ext.Button({
            text: "Near By",
            id: 'near-by',
            scope: this,
            style: 'background-color:240800;'
        });

        var commonTools = new Ext.form.FieldSet({
            title: 'Common Tasks',
            collapsible: true,
            buttonAlign: 'center',
                 buttons: [{
   ...
   , buttonAlign: 'center'
    , buttons: [{
        text: 'Google Street'
                ...
                , columnWidth: .30
                , handler: function () {
                    umap.map.setBaseLayer(layerArray[1]);
        ...
        text: 'Google Satellite'
               ...
               , id: 'gsa'
                , handler: function () {
                    umap.map.setBaseLayer(layerArray[2]);
                }
    }, {
        text: 'OpenStreet Maps'
           ...
           , id: 'osm'
           , handler: function () {
               umap.map.setBaseLayer(layerArray[0]);
           }
    }]
        });
